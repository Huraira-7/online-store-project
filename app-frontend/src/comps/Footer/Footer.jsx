  ...
  return (
     ...
     :
        ...
        <div className="flex max-[1440px]:flex-col max-[1440px]:mb-8 mx-0 h-24 items-center justify-between px-4 md:px-6 w-full">
          ...
          <div className="flex text-xl pt-4 px-6 md:px-20 md:pt-12 justify-center mb-3 mt-10"> Subscribe to our emails for latest product arrivals</div>
          <div className="flex items-center justify-between rounded-md">
            ...
            <div className="row flex justify-center text-wrap">
              <div className="flex text-xl max-[600px]:text-sm py-4 px-4 md:px-20 md:pt-12 md:pb-6 max-[500px]:flex-col">
