...
function Category({category,setLoading,loading}) {
  ...
  const starter=  `https://online-store-project-backend-z0bqj2z6s-huraira-7s-projects.vercel.app/` // 'https://online-store-project-production.up.railway.app/' // 'http://192.168.100.136:3000/'
